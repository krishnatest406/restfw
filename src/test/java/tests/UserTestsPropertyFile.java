...
public class UserTestsPropertyFile {
	...
	public void createUserMain() {		
		...
		Response res=UserEndPointsPropertyFile.createUser(ud);
		res.then().log().all();
	...
	public void getUserMain() {		
		Response res=UserEndPointsPropertyFile.getUser(this.ud.getUsername());
		res.then().log().all();
	...
	public void updateUserMain() {	
		...
		Response res=UserEndPointsPropertyFile.updateUser(this.ud.getUsername(),ud);
		res.then().log().body();
	...
	public void deleteUserMain() {		
		...
		Response res=UserEndPointsPropertyFile.deleteUser(this.ud.getUsername());
		res.then().log().all();
